...
public class MainPanel extends DefaultLauncherPanel {
    ...
    public MainPanel(int width, int height) throws IOException {
        ...
        logo.setBounds((width - logoIcon.getIconWidth()) / 2, 0, logoIcon.getIconWidth(), logoIcon.getIconHeight());
        this.add(logo);
        ...
        this.add(new CloseButton(this,height - backgroundIcon.getIconHeight()));

        render = new RenderJLabel(renderIcon);

        // Ajout de la structure de la fenêtre
        JLabel background = new JLabel(backgroundIcon);
        background.setBounds(width - backgroundIcon.getIconWidth(), height - backgroundIcon.getIconHeight(), backgroundIcon.getIconWidth(), backgroundIcon.getIconHeight());
        this.add(background);
